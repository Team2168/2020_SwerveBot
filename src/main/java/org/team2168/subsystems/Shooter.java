...
public class Shooter extends Subsystem {
    ...
    private final double WHITE_LINE_VEL = 2390.0;
    private final double FRONT_TRENCH_VEL = 2750.0;
    private final double BACK_TRENCH_VEL = 4390.0;


    private final double WALL_VEL_PBOT = 1540.0; //new red balls
    private final double WHITE_LINE_VEL_PBOT = 2390.0;
    private final double FRONT_TRENCH_VEL_PBOT = 2750.0;
    private final double BACK_TRENCH_VEL_PBOT = 4390.0; //
    ...
    private Shooter() {
        ...
        _motorTwo = new TalonFX(RobotMap.SHOOTER_2_CAN_ID);
